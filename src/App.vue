        ...
        <div class="app" id="app">
            ...
            <header class="app-header" id="fixedHeader">
                ...
                <div class="right">
                    ...
                    <button class="btn ghost" id="btnNotifications" aria-label="通知中心">🔔 <span
                            class="badge danger">9+</span></button>
            ...
            <aside class="sidebar" id="sidebar">
                <ul class="menu">
                    <li><a href="#" aria-current="page"><span class="icon">📊</span><span class="label">仪表盘</span></a>
                    </li>
            ...
            <main class="app-main" id="main">
                ...
                <section class="grid" style="margin-top: var(--space-6); grid-template-columns: 2fr 1fr;">
                    <article class="card">
                        ...
                        <div
                            style="height:260px; display:flex; align-items:center; justify-content:center; color:var(--fg-muted); border:1px dashed var(--divider); border-radius: var(--radius);">
                            图表占位
                        </div>
                    </article>
                    <article class="card">
                ...
                <section style="margin-top: var(--space-6);" class="card">
                    ...
                    <div
                        style="height:160px; display:flex; align-items:center; justify-content:center; color:var(--fg-muted); border:1px dashed var(--divider); border-radius: var(--radius);">
                        复杂交互模块占位
                    </div>
                </section>
            </main>
